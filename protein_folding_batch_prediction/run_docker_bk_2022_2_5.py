...
DOWNLOAD_DIR = '/protein_folding/dataset_alphafold2'

# Name of the AlphaFold Docker image.
docker_image_name = 'alphafold_my_patch'

# Path to a directory that will store the results.
output_dir = '/protein_folding/results/alphafold'
...
def main(argv):
  ...
  container = client.containers.run(
      ...
      entrypoint='/app/run_alphafold.sh',  #jji add
